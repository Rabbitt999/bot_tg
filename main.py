зроби ліміт повідомлень в боті. коли користувач досягає ліміту то появляється alert повідомлення. . напиши повний код з лімітом повідомлень alert 
Ось код:                                                                                                                                                                      import telebot
import json
import random
import os
import re
