зараз бот може автоматично завантажувати фільми тільки з TMDB але це не завжди працює, зроби ще один варіант завантаження фільмів в бот і щоб було таке саме оформлення фільмів, тобто бот шукає фільм на tmdb якщо нема то шукає через другий спосіб. напиши повний код зі всіма функціями.
Ось код:
import telebot
import json
import random
